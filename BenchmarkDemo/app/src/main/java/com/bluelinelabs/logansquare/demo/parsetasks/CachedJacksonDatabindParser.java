...
public class CachedJacksonDatabindParser extends Parser {

    private final ObjectMapper objectMapper;

    public CachedJacksonDatabindParser(ParseListener parseListener, String jsonString, ObjectMapper objectMapper) {
